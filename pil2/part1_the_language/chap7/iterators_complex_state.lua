...
The simplest solution is to sue closures. An alternative solution is to pack
...
The function that starts the iteration si simple. It must return the iterator
...
--[[
Whenever possible, I should try to write stateless iterators, thsoe that keep 
